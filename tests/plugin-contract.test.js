...
test('release train is 1.5.0', async () => {
  ...
  assert.equal(claude.version, '1.5.0');
  assert.equal(codex.version, '1.5.0');
  assert.equal(pkg.version, '1.5.0');
  assert.deepEqual(fixtures.map((fixture) => fixture.envelope.producer_version), Array(4).fill('1.5.0'));
